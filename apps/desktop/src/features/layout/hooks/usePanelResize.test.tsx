// usePanelResize — drag-to-resize for left/right side panels.
// Verifies clamping, persistence to localStorage, and listener cleanup on
// mouseup. The hook persists width via useLocalStorage so reload picks up
// the last user-chosen size.
