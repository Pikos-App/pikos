// useAutosave — debounced auto-save hook for continuous-input fields.
// Used by EditorPane (content), TitleField, SubtitleField.
// Immediate-save fields (status, priority, tags) should NOT use this — call updatePage directly.
...
export function useAutosave<T>(
  ...
  // Schedule debounced save when value changes
  useEffect(() => {
