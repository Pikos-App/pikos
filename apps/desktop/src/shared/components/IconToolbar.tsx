// IconToolbar — roving-tabIndex toolbar for small icon button groups.
//
// ARIA pattern: role="toolbar", one button has tabIndex=0 at a time.
// ArrowLeft/Right moves focus within the group; Tab exits to the next tabbable element.
