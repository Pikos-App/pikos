// ReminderDropdown — bell icon that opens a dropdown for per-page reminder config.
// Used in MetadataHeader byline and PageBlockPopover date row.
// Options toggle on/off with checkmark on right. Matches tag/folder/priority style.
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="w-52">
        ...
        {/* Lead time options — toggle on/off. Default shown as active when no overrides. */}
        ...
        {/* Reset to default — only when page has overrides */}
