// ListSettingsContext — density preference for page list + folder list.
// Persisted to localStorage. Consumed by PageListItem, PageListPanel,
// SidebarListItem, and FolderList.
