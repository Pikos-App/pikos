...
- When adding a task via quick add, should we open the task page or just add it to the side page list? Should we go to that folder? Probably not.

To Document
- + button on page list should open quick add
- folder list should get sort options
