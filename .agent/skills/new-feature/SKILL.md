---
name: new-feature
description: How to scaffold a new feature module in the Pikos Tauri + React monorepo. Use when adding any new feature to the desktop app — creates the directory structure, wires storage, registers shortcuts, and connects to WorkspaceContext.
...
6. Wire into `WorkspaceContext` if the feature owns shared state
