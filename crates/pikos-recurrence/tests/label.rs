...
fn matches_the_harvested_totext_table() {
    ...
    assert_label(
        ...
        "every month on the 15th and last",
    );
    assert_label(
        "FREQ=MONTHLY;BYMONTHDAY=1,2,3",
        "every month on the 1st, 2nd and 3rd",
    );
    assert_label(
    ...
    assert_label(
        ...
        "every month on Monday and on the 2nd Wednesday",
    );
    ...
    assert_label(
        ...
        "every March on the 15th",
    );
    assert_label(
        "FREQ=YEARLY;BYMONTH=11;BYDAY=4TH",
        "every November on the 4th Thursday",
    );
    ...
    assert_label(
        ...
        "every January and July on the 10th",
    );
    assert_label(
        "FREQ=MONTHLY;BYMONTH=1;BYDAY=2MO",
        "every January on the 2nd Monday",
    );
    assert_label(
        "FREQ=WEEKLY;BYDAY=MO;BYMONTH=6,7",
        "every week in June and July on Monday",
    );
    ...
    assert_label(
        ...
        "every week on Monday for 10 times",
    );
    assert_label(
    ...
    assert_label(
        "FREQ=MONTHLY;INTERVAL=6;COUNT=2",
        "every 6 months for 2 times",
    );
    assert_label(
        "FREQ=WEEKLY;UNTIL=20260628T235959Z",
        "every week until June 28, 2026",
    );
    assert_label(
        "FREQ=YEARLY;INTERVAL=3;UNTIL=20300101T000000Z",
        "every 3 years until January 1, 2030",
    );
    assert_label(
        "FREQ=WEEKLY;BYDAY=MO;UNTIL=20261231T235959Z",
        "every week on Monday until December 31, 2026",
    );
    assert_label(
